...
import jhi.swtcommons.util.Parameter
import jhi.swtcommons.util.ParameterStore

/**
 * @author Sebastian Raubach
 */

object HumbugParameterStore : ParameterStore()
{
    override fun getAsString(key: Parameter): String?
    {
